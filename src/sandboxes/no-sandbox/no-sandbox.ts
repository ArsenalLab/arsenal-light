    ...
    const handle: SandboxHandle = {
      ...
      interactiveExec: (
        ...
        return new Promise((resolve, reject) => {
          ...
          //
          // spawn's stdio array only accepts "pipe"/"inherit"/"ignore"/fd —
          // not stream objects. Use "pipe" and wire the caller's streams
          // manually so AcpSession's PassThrough streams connect correctly.
          ...
          // Wire caller streams ↔ process stdio
