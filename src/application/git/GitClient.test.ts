 ...
 * than local child_process.exec". Still runs locally under the hood, but
 * it's a genuinely different code path than `LocalGitClient`'s, proving
 * `makeGitClient` isn't secretly coupled to child_process's exact call
 * shape.
 */
