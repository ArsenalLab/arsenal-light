...
describe("defaultImageName", () => {
  it("derives image name from POSIX repo directory", () => {
    expect(defaultImageName("/home/user/my-repo")).toBe("arsenal:my-repo");
  });
  ...
  it("handles trailing slashes", () => {
    expect(defaultImageName("/home/user/repo/")).toBe("arsenal:repo");
  });

  it("falls back to 'local' for empty path", () => {
    expect(defaultImageName("")).toBe("arsenal:local");
  });

  it("handles Windows paths with backslashes", () => {
    expect(defaultImageName("C:\\Users\\project")).toBe("arsenal:project");
  });
...
describe("patchGitMountsForWindows", () => {
  ...
  describe("on Windows platform", () => {
    ...
    it("remaps parent .git dir and adds overlay mount for Arsenal-created worktree", async () => {
      // Scenario B: Arsenal created a worktree. resolveGitMounts returned
