...
const worktreesDir = "C:\\repo\\.arsenal\\worktrees";
const gitWorktreePath = "C:/repo/.arsenal/worktrees/feature-x";
const joinWorktreePath = "C:\\repo\\.arsenal\\worktrees\\feature-x";

describe("findCollidingWorktree", () => {
  it("matches by branch name", () => {
    const existing = [
      { path: gitWorktreePath, branch: "feature-x" },
      { path: "C:/repo/.arsenal/worktrees/other", branch: "other" },
    ];
