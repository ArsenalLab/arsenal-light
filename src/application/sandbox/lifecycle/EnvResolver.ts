 ...
 *
 * Precedence: .arsenal/.env > process.env
 * Only keys declared in .arsenal/.env are resolved from process.env.
...
export const resolveEnv = (
  ...
  Effect.gen(function* () {
    const arsenalEnv = yield* parseEnvFile(join(repoDir, ".arsenal", ".env"));
