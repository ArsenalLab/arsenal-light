...
describe("buildRecoveryMessage", () => {
  const patchDir = ".arsenal/patches/20260324-153000";
  ...
  describe("--branch recovery commands", () => {
    ...
    it("git am failure includes worktree setup", () => {
      ...
      expect(msg).toContain("git worktree add .arsenal/worktree feature/test");
      expect(msg).toContain("cd .arsenal/worktree");
      expect(msg).toContain("git am --continue");
    });
